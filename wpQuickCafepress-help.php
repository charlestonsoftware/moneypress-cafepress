...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>wpQuickCafepress Help</title>
    <style>
      body {
  ...
  <body>
    <h1>wpQuickCafepress Help</h1>
    <p>This document will explain how to set up the plugin and use it in your Wordpress posts or pages.</p>
    ...
    <p>Click the &quot;Create Quick Cafepress Shortcode&quot; button and the shortcode text will appear in your text editor. You can add any additional text above or below the shortcode, and it will appear in that place in the post or page. Note that on pages like the front page of you blog, only the number of products you designated in the &quot;preview&quot; field will show, followed by a &quot;View All&quot; link to get to the post.</p>
    <h3>Appearance</h3>
    ...
    <p>Support can be found online at <a href="http://www.cybersprocket.com">http://www.cybersprocket.com</a> or feel free to email us at <a href="mailto:info@cybersprocket.com">info@cybersprocket.com</a>.</p>
    <p><strong>What does this cost?</strong></p>
    <p>We request a nominal donation of $5 to help offset our development and maintenance costs! There no click-share or rev share involved.
    All commissions are yours. If you find that the plugin helps make you money and you like to see further development on this and other similar
    plugins, please consider making a donating via paypal at <a href="http://www.cybersrocket.com/products/wpquickcafepress">http://www.cybersrocket.com/products/wpquickcafepress</a></p>
